...
multicore_testi() ->
    ...
    TwoPids = [spawn(fun() -> erlang:display({first_instr, self()}), numerl:add(Mat1,Mat2)end),spawn(fun() -> erlang:display({first_instr, self()}), numerl:add(Mat1,Mat2)end)],
