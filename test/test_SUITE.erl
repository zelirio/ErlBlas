...
tr_testi() ->
    ...
    erlang:display(
        block_mat:toErl(Mat1)),
    erlang:display(
        block_mat:toErl(
            block_mat:transpose(Mat1))).
...
daxpy_test() ->
    ...
    ?assert(mat:'=='(
                numerl:mtfl(YN), block_mat:toErl(Y))). % Value is correct
...
dscal_test() ->
    ...
    ?assert(mat:'=='(
                numerl:mtfl(XN), block_mat:toErl(X))). % Value is correct
...
dgemm_testi() ->
    ...
    erlang:display(mat2),
    erlang:display(
        block_mat:toErl(Mat2)),
    Mat3 = block_mat:matrix(generateRandMat(2, 2)),
    erlang:display(mat3),
    erlang:display(
        block_mat:toErl(Mat3)),
    erlang:display(mult),
    erlang:display(
        block_mat:toErl(
            block_mat:mult(Mat1, Mat2))),
    erlang:display(dgemm),
    erlang:display(
        block_mat:toErl(
            block_mat:dgemm(false, false, 1.0, 0.0, Mat1, Mat2, Mat3))),
    erlang:display(plusC),
    erlang:display(
        block_mat:toErl(
            block_mat:dgemm(false, false, 1.0, 1.0, Mat1, Mat2, Mat3))),
    erlang:display(transpA),
    erlang:display(
        block_mat:toErl(
            block_mat:dgemm(true, false, 1.0, 0.0, Mat1, Mat2, Mat3))),
    erlang:display(transpB),
    erlang:display(
        block_mat:toErl(
            block_mat:dgemm(false, true, 1.0, 0.0, Mat1, Mat2, Mat3))),
    erlang:display(halfAB),
    erlang:display(
        block_mat:toErl(
            block_mat:dgemm(false, false, 0.5, 0.0, Mat1, Mat2, Mat3))),
    erlang:display(halfC),
    erlang:display(
        block_mat:toErl(
            block_mat:dgemm(false, false, 1.0, 0.5, Mat1, Mat2, Mat3))).
